...
export const copy = {
  "zh-CN": {
    ...
    updater: {
      ...
      speed: "下载速度",
      proxyDetected: "已使用系统或环境代理",
      proxyDirect: "未检测到显式代理（可能为直连或 TUN 模式）",
      badge: "有新版本",
    },
  },
  "en-US": {
    ...
    updater: {
      ...
      proxyDetected: "Using a system or environment proxy",
      proxyDirect: "No explicit proxy detected (direct or TUN mode)",
