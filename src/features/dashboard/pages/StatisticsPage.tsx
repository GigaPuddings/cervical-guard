...
const statisticsMessages = defineMessages({
  away: { zh: '离开座位', en: 'Away from seat' },
  headDown: { zh: '持续低头', en: 'Head down' },
  breakAfterReminder: { zh: '提醒后休息', en: 'Break after reminder' },
  proactiveBreak: { zh: '主动休息', en: 'Take a break' },
  earlyBreak: { zh: '提前休息', en: 'Early break' },
  proactivePause: { zh: '主动暂停', en: 'Manual pause' },
  reminderAction: { zh: '提醒操作', en: 'Reminder action' },
  averageSitting: { zh: '每日坐姿时间', en: 'Daily sitting time' },
  dailyAverage: { zh: '日均值', en: 'Daily average' },
  longest: { zh: '最长连续坐姿', en: 'Longest sitting session' },
  appearedOn: { zh: '出现在', en: 'Occurred on' },
  cumulativeHeadDown: { zh: '累计低头时间', en: 'Total head-down time' },
  dailyAveragePrefix: { zh: '日均', en: 'Daily average' },
  reminders: { zh: '次提醒', en: 'reminders' },
  awayActivity: { zh: '离座活动时间', en: 'Time away from desk' },
  awayEvents: { zh: '次离座', en: 'away events' },
  ...
  title: { zh: '你的习惯趋势', en: 'Your habit trends' },
  subtitle: { zh: '数据来自本地检测，仅供参考。坚持良好习惯，守护颈椎健康。', en: 'Data comes from local detection and is for reference only. Build healthy habits and care for your neck.' },
  last7Days: { zh: '近 7 天', en: 'Last 7 days' },
  last30Days: { zh: '近 30 天', en: 'Last 30 days' },
  dailyBehavior: { zh: '每日行为', en: 'Daily behavior' },
  trendTitle: { zh: '坐姿与低头变化', en: 'Sitting and head-down trends' },
  sitting: { zh: '坐姿', en: 'Sitting' },
  headDownShort: { zh: '低头', en: 'Head down' },
  sittingMinutes: { zh: '坐姿（分钟）', en: 'Sitting (minutes)' },
  headDownMinutes: { zh: '低头（分钟）', en: 'Head down (minutes)' },
  chartLabel: { zh: '坐姿与低头分钟趋势柱状图', en: 'Sitting and head-down duration bar chart' },
  observation: { zh: '本期观察', en: 'Observation' },
  positiveObservation: { zh: '你正在主动打断久坐，继续保持自己的节奏。', en: 'You are actively interrupting long sitting. Keep your rhythm.' },
  emptyObservation: { zh: '今天可以从一次主动休息开始。', en: 'Start today with one intentional break.' },
  recent: { zh: '最近记录', en: 'Recent activity' },
  today: { zh: '今日', en: 'Today' },
  all: { zh: '全部', en: 'All' },
  records: { zh: '条', en: 'records' },
  chooseDate: { zh: '选择行为记录日期', en: 'Select behavior history date' },
  historyDate: { zh: '行为记录日期', en: 'Behavior history date' },
  previousYear: { zh: '上一年', en: 'Previous year' },
  previousMonth: { zh: '上个月', en: 'Previous month' },
  nextMonth: { zh: '下个月', en: 'Next month' },
  nextYear: { zh: '下一年', en: 'Next year' },
  todayButton: { zh: '今天', en: 'Today' },
  loadingHistory: { zh: '正在读取当日记录…', en: 'Loading activity for this day…' },
  instant: { zh: '即时', en: 'Instant' },
  noHistoryToday: { zh: '今日还没有行为记录', en: 'No activity recorded today' },
  noHistory: { zh: '没有行为记录', en: 'No activity recorded' }
})

const historyActionMessages = defineMessages({
  returned: { zh: '已返回', en: 'Returned' },
  recovered: { zh: '已恢复', en: 'Recovered' },
  started: { zh: '已开始', en: 'Started' },
  completed: { zh: '已完成', en: 'Completed' },
  timed: { zh: '定时暂停', en: 'Timed pause' },
