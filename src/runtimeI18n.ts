...
const zhToEn: Record<string, string> = {
  ...
  "持续检测状态": "Persistent detection status", "常驻紧凑状态，悬停查看详情": "Keep a compact status; hover for details", "与普通窗口同时显示": "Show with main window", "主窗口可见时也显示灵动岛": "Show Dynamic Island while the main window is visible", "允许从灵动岛彻底关闭": "Allow permanent close from Dynamic Island", "开启后关闭菜单才显示彻底关闭选项": "Adds a permanent-close option to its menu",
